    ...
    , _runningUnitTests     (unitTesting)
{
    ...
    if (_runningUnitTests) {
        ...
        applicationName = "JebiGroundStation"; //applicationName = QStringLiteral("%1 Daily").arg(QGC_APPLICATION_NAME);
#else
        applicationName = "JebiGroundStation"; //applicationName = QGC_APPLICATION_NAME;
#endif
    }
