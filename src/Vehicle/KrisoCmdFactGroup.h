...
public:
    ...
    Q_PROPERTY(Fact*  logging_status            READ logging_status   CONSTANT)     
    ...
    Fact*       logging_status    (){return &_logging_status;}  
    ...
    static const char* _logging_statusFactName;
