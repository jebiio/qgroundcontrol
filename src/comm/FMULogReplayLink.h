...
class FMULogReplayLinkConfiguration : public LinkConfiguration
{
    Q_OBJECT
...
public:
    ...
    FMULogReplayLinkConfiguration(const QString& name);
    FMULogReplayLinkConfiguration(FMULogReplayLinkConfiguration* copy);
...
class FMULogReplayLink : public LinkInterface
{
    Q_OBJECT

public:
    FMULogReplayLink(SharedLinkConfigurationPtr& config);
    virtual ~FMULogReplayLink();
...
private:
    ...
    quint64 _seekToNextFMUMessage   (FmuStream* nextMsg); //quint64 _seekToNextMavlinkMessage   (mavlink_message_t* nextMsg);
    quint64 _findLastTimestamp          (void);
    quint64 _readNextFMUMessage     (QByteArray& bytes);//    quint64 _readNextMavlinkMessage     (QByteArray& bytes);
    ...
    FMULogReplayLinkConfiguration* _logReplayConfig;
...
class FMULogReplayLinkController : public QObject
{
    Q_OBJECT

public:
    Q_PROPERTY(FMULogReplayLink*   link            READ link               WRITE setLink               NOTIFY linkChanged)
